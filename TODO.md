...
* Rename every file that has `Carbon.Permissions` in its name, replacing `Carbon.Permissions` with the module name.
* Replaces `Carbon.Permissions` in every file with the module name.
